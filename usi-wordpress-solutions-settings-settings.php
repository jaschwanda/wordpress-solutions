         ...
         'admin-limits' => [
            ...
            'settings' => [
               ...
               'mpdf-temp-dir' => [
                  'f-class' => 'regular-text', 
                  'type' => 'text', 
                  'label' => 'mPDF Temp Directory',
                  'notes' => 'You should set a temporary directory with read/write access as mPDF defaults to the composer vendor directory.',
               ],
               'mpdf-pcre-limit' => [
                  'f-class' => 'regular-text', 
                  'label' => 'mPDF pcre.backtrack_limit',
