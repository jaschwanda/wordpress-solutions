   ...
   function sections() {
      ...
      $sections = array(
         ...
         'builder' => array(
            ...
            'header_callback' => array($this, 'sections_header', '    <p>' . __('Form Builder.', USI_WordPress_Solutions::TEXTDOMAIN) . '</p>' . PHP_EOL),
            'footer_callback' => array($this, 'sections_footer', 'Build Form'),
            'localize_labels' => 'yes',
            'localize_notes' => 3, // <p class="description">__()</p>;
            'settings' => array(
               'content' => array(
